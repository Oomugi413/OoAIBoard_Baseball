...
- チーム略称は拡大率を上げてもチーム枠の上下中央に置く。最大拡大率は180%とし、最大時はチーム枠の高さの8割程度まで大きく表示する。縦位置は、英字フォントの大文字と日本語フォントの全角カタカナの見え方の中間で、視覚的にバランスよく中央へ見える位置に固定する。
...
- 英字表示: D-DIN PRO / D-DIN PRO Condensed を優先する。
